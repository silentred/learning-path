...
import re, sqlite3, ast, MySQLdb, logging, pinyin, datetime, math, time, MySQLdb, logger
...
myLogger = logging.getLogger('v1188ys.importer.variety')
def initSession():
...
def searchAndSaveVideo(session, movie, video_type_id):
    ...
    try:
        ...
        myLogger.error('Unknown error: %s ' % e) 
        raise e
    return movie
